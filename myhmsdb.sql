...
INSERT INTO `statb` (`username`, `password`, `email`, `spec`, `staSalary`) VALUES
...
INSERT INTO `prestb` (`staff`, `pid`, `ID`, `fname`, `lname`, `appdate`, `apptime`, `disease`, `allergy`, `prescription`) VALUES
